...
void QInputDialog_setInputMode(void* dialog, enum QInputDialogInputMode mode);
enum QInputDialogInputMode QInputDialog_inputMode(void* dialog);
...
void QInputDialog_setOption(void* dialog, enum QInputDialogOption option, bool on);
bool QInputDialog_testOption(void* dialog, enum QInputDialogOption option);
