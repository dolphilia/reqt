...
void* QSize_operator_multiply(void* size, double factor); // QSize & operator*=(qreal factor)
void* QSize_operator_add(void* size1, void* size2); // QSize & operator+=(const QSize &size)
void* QSize_operator_subtract(void* size1, void* size2); // QSize & operator-=(const QSize &size)
void* QSize_operator_divide(void* size, double divisor); // QSize & operator/=(qreal divisor)
