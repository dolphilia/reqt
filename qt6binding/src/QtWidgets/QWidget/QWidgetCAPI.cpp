...
void* QWidget_create(void* parent) {
    return new QWidgetBind(static_cast<QWidget*>(parent));
}
...
int QWidget_backgroundRole(void* widget) {
    return static_cast<QWidgetBind*>(widget)->backgroundRole();
}
...
int QWidget_foregroundRole(void* widget) {
    return static_cast<QWidgetBind*>(widget)->foregroundRole();
}
...
int QWidget_contextMenuPolicy(void* widget) {
    return static_cast<QWidgetBind*>(widget)->contextMenuPolicy();
}
...
int QWidget_focusPolicy(void* widget) {
    return static_cast<QWidgetBind*>(widget)->focusPolicy();
}
...
int QWidget_inputMethodHints(void* widget) {
    return static_cast<QWidgetBind*>(widget)->inputMethodHints();
}
...
int QWidget_layoutDirection(void* widget) {
    return static_cast<QWidgetBind*>(widget)->layoutDirection();
}
...
int QWidget_windowFlags(void* widget) {
    return static_cast<QWidgetBind*>(widget)->windowFlags();
}
...
int QWidget_windowModality(void* widget) {
    return static_cast<QWidgetBind*>(widget)->windowModality();
}
...
int QWidget_windowState(void* widget) {
    return static_cast<QWidgetBind*>(widget)->windowState();
}

int QWidget_windowType(void* widget) {
    return static_cast<QWidgetBind*>(widget)->windowType();
}
